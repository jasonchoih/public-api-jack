...
{
    const { _category, _type, _plan, _trial, _featured, _tag, image_name, apiEditLoading } = useSelector((state) => state.models);
    ...
    //         reader.onload = () => {
    //             dispatch.models.SET({
    //                 Image: { image_data: reader.result, image_name: file['name'] }
    //             })
    //         }
    //     }
    // }
        ...
        <form onSubmit={handleSubmit(onSubmit)} id='form'>
            <div className='grid grid-cols-12 gap-5'>
                ...
                <div className='col-span-6 flex flex-col gap-2'>
                    ...
                    <div>
                            ...
                            onSuccess={(result, { widget }) => 
                            {
                                if(result&&result.event=='success'){
                                    dispatch.models.SET({ 
                                        ...
                                        // image_name: result.info.original_filename + '.' + (result.info.original_extension || result.info.format),
                        ...
                        >
                            {({ open }) => {
                                ...
                                //     onClick={()=> {
                                //         open();
                                //         dispatch.models.SET({isUploaded: true})
                                //     }}
                                // >
                                //     Upload an Image
                                // </LoadingButton>
                                return <CldImage 
                                    ...
                                    width="0" 
                                    height="0" 
                                    // src={'public_api/'+(image_name||_image_name)+'.png'} 
                                    src={`https://res.cloudinary.com/ddv2aeipa/image/upload/v1719214653/${(image_name||_image_name)}`}
                                    sizes="100vw" 
                    ...
                    <div>
                        {/* <img src={Image&&Image.image_data || 'https://res.cloudinary.com/ddv2aeipa/image/upload/v1718994717/api/' + image_name + '.png'} className='h-auto max-w-28' /> */}
                        {/* <CldImage width="0" height="0" src={`https://res.cloudinary.com/ddv2aeipa/image/upload/v1719214653/${(image_name||_image_name)}`} sizes="100vw" alt={image_name} className='h-auto w-28' />  */}
                    </div>
                </div>
            </div>
