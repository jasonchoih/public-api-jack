...
{
    const { onCategory, showSubContent } = useSelector((state) => state.models);
    // 
                    ...
                    <div className='grid grid-cols-12 items-center gap-3'>
                        <div className='col-span-3'>
                            <CldImage 
                                width="0" 
                                height="0" 
                                src={`https://res.cloudinary.com/ddv2aeipa/image/upload/v1719214653/${apis[k]['img']}`} 
                                sizes="100vw" alt={apis[k]['img']} 
