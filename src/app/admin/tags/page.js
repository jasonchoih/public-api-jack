...
const AddTag = dynamic(() => import('@/components/forms/add/tag'), {ssr:false, loading:()=><Loader />})
const EditTag = dynamic(() => import('@/components/forms/edit/tag'), {ssr:false, loading:()=><Loader />})
// 
export default () =>
{
