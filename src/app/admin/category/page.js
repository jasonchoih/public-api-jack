...
const AddCategory = dynamic(() => import('@/components/forms/add/category'), {ssr:false, loading:()=><Loader />})
const EditCategory = dynamic(() => import('@/components/forms/edit/category'), {ssr:false, loading:()=><Loader />})
// 
export default () =>
{
